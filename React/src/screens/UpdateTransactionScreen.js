...
export default function EditTransactionScreen({ navigation, route }) {
    ...
    useEffect(() => {
        fetch('http://192.168.0.9:8080/ffm/categories')
    ...
    const fetchBudgets = async () => {
        try {
            ...
            const response = await fetch(`http://192.168.0.9:8080/budgets`, {
                method: 'GET',
                headers: {
    ...
    const fetchGoals = async () => {
        try {
            ...
            const response = await fetch(`http://192.168.0.9:8080/goals`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
